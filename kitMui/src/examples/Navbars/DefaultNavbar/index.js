  ...
  return (
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      <Box
        ...
        style={{ color: "green", borderRadius: "50%", backgroundColor: "transparent" }}
        left={0}
        zIndex={3}
      ...
      >
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box component={Link} to="/" lineHeight={1}>
            <Typography variant="button" style={{ color: "yellow", fontWeight: "bold" }}>
              {brand}
            </Typography>
          </Box>
          <Box
            ...
            {action &&
              (action.type === "internal" ? (
                <Button
                  ...
                  to={action.route}
                  variant="contained"
                  style={{ color: "white", textTransform: "capitalize", fontSize: "1rem" }}
                  size="small"
                >
                  {action.label}
                </Button>
